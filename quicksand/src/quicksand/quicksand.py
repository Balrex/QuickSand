...
class quicksand:
    ...
    try:
        ...
        # pdfyara = '/home/boris/quicksand/src/quicksand/quicksand_pdf.yara'
    ...
    def __init__(self, data, capture=False,strings=True, debug=False, timeout=0, exploityara=None, execyara=None,pdfyara=None, password=None):
        ...
        print(f"Path to YARA file: {pdfyara}") 
        ...
        self.exploitrules = yara.compile(filepath='/home/boris/quicksand/src/quicksand/quicksand_exploits.yara')
        # self.execrules = yara.compile(filepath=self.execyara)
        self.execrules  = yara.compile(filepath='/home/boris/quicksand/src/quicksand/quicksand_exe.yara')
        # self.pdfrules = yara.compile(filepath=self.pdfyara)
        self.pdfrules = yara.compile(filepath='/home/boris/quicksand/src/quicksand/quicksand_pdf.yara')
    ...
    def metadata(self):
        ...
        # self.results['quicksand_pdf.yara'] = os.path.getmtime('/home/boris/quicksand/src/quicksand/quicksand_exe.yara')
        # self.results['quicksand_pdf.yara'] = os.path.getmtime(self.pdfyara)
        # self.results['quicksand_pdf.yara'] = os.path.getmtime('/home/boris/quicksand/src/quicksand/quicksand_pdf.yara')
